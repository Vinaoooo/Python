...
def accepted():
    messagebox.showinfo('São Paulo', '1930')
...
margin.pack()
text_id = Label(root, bg='#ffc8dd', text='Sim???', fg='#590d22', font=('Montserrat', 24, 'bold'))


text_id.pack()
button_1 = tk.Button(root, text='Não', bg='#ffb3c1', relief=RIDGE, bd=3, command=accepted, font=('Montserrat', 8, 'bold'))
